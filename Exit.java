...
public class Exit {
  ...
  private ArrayList<String> shedItems = new ArrayList(Arrays.asList("can", "shovel"));
  ...
  private Place shed = new Place("shed", shedItems, "a small wooden room. \nThere are a few tools hanging on the wall, including a shovel and a saw. \nOn the floor is a watering can, full of water.");
  private Place garden = new Place("garden", gardenItems,"a small patch of land fenced off with plastic net. \nInside the patch of land, there is a small plant with a cage around it.");
  private Place dining = new Place("dining", diningItems, "an elegantly set table with three chairs around it. \nA beautiful picture window overlooks your garden. \nOn a shelf below the window, there's a recipe book and a happy basil plant.");
  private Place kitchen = new Place("kitchen", kitchenItems, "a well-lit room with an oven and a fridge. \nThe floor is tiled with brightly colored ceramic, and there's a whiff of nutmeg in the air. \nYou feel warm, held, and a bit hungry. A doorway leads to the dining room.");
